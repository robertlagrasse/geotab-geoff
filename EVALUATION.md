...
| Have a backup plan if live demo fails | Two-layer GPU warmup on login. Creator-driven demo. Demo videos in `demos/` as fallback. |
...
| Keep it under 5 minutes | Two demo videos already generated by the platform itself (2-min intro + 5-min deep dive) |
