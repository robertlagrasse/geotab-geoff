...
| Have a backup plan if live demo fails | Two-layer GPU warmup on login. Creator-driven demo. [9-video YouTube series](https://www.youtube.com/playlist?list=PLJc554ozx033qJkQ_TSEX_r5106JklITE) as fallback. |
...
| Show live demo with real data | geotab-geoff.web.app with 90 real events from the Geotab demo database |
...
| Keep it under 5 minutes | [9-video "Geoff Explains" YouTube series](https://www.youtube.com/playlist?list=PLJc554ozx033qJkQ_TSEX_r5106JklITE) — each generated by the platform's own pipeline |
...
4. **Deployed and live.** Not localhost. Not screenshots. Not "it works on my machine." Firebase Hosting + Cloud Functions + Cloud Run GPU — all live, all working.
